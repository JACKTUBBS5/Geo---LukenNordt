...
title 'SoilGeoChem';
/*
*To import data from Paleoclimate folder;
libname Location "C:\Users\RDaneel\Documents\Research\Baylor\BU-SI\Paleoclimate\PLSR Model Test\TP Spline";
...
/*data geo;
	format 	Fe2O3 MnO P2O5 SiO2 TiO2 ZrO2 Al2O3 CaO Na2O MgO K2O 
			...
			8.2;
	set Tpspline.results_1001; 
	where cl_MAP ne .  and cl_MAT ne .;
	lCaO = log(CaO);
...
proc import datafile="C:\Users\RDaneel\Documents\Research\Baylor\BU-SI\Paleoclimate\PLSR Model Test\TP Spline\geo.csv"
     out=geo
     dbms=csv
     replace;
     getnames=yes;
...
data geo; set sasuser.geo_luken; 
	keep pedon_id cl_MAP cl_MAT
			Fe2O3 MnO P2O5 SiO2 TiO2 ZrO2 Al2O3 CaO Na2O MgO K2O 
			Fe2O3_mol MnO_mol P2O5_mol SiO2_mol TiO2_mol ZrO2_mol 
			Al2O3_mol CaO_mol Na2O_mol MgO_mol K2O_mol lCaO;
run;
proc sort data=geo;* out=geo;
	by pedon_id;
run;
...
*User's data (example);
data user;
	input Pedon_ID $ Fe2O3 MnO P2O5 SiO2 TiO2 ZrO2 Al2O3 lCaO Na2O MgO K2O Till SubglacialTill;
	datalines;
	temp1 5.82 0.05 0.15 57.91 0.84 0.02 05.45 -1.52 0.98 0.24 1.45 0 0 
	temp2 5.42 0.07 0.09 64.81 0.80 0.01 12.74  0.03 1.22 1.35 1.84 0 0
	temp3 6.10 0.08 0.09 65.93 0.91 0.02 12.19 -0.38 1.17 0.77 1.92 0 0
	temp4 6.01 0.04 0.12 65.96 0.66 0.02 10.12 -1.16 1.28 1.27 1.48 0 1
	temp5 3.64 0.05 0.10 70.96 0.49 0.02 06.91 -0.67 1.02 0.92 1.69 1 0
	temp6 8.30 0.01 0.20 47.20 1.65 0.03 15.40  1.79 2.60 2.13 1.00 0 0
	temp7 5.82 .05  .15  57.91 .84  .02  5.45   .21871188695 .98  .24  1.45 0 0
	temp8 8.3  0.01 0.2  47.20 1.65 0.03 15.4  1.7917594692281  2.6  2.13 1    0 0
	;
...
*Model;																				*MolModel. FCW 7/7/13;
%let MolModel = Fe2O3_mol MnO_mol P2O5_mol SiO2_mol TiO2_mol Al2O3_mol CaO_mol Na2O_mol MgO_mol K2O_mol;


*-------------------------- Universal model -------------------------------*;		*MolModel. FCW 7/7/13;
...
*------------- Universal model adjustments --------------------*;					*Updated numbers. FCW 7/7/13;
data pred_adj;
	set user_pred;
...
run;
/*
libname Datasets "C:\Users\RDaneel\Documents\Research\Baylor\BU-SI\Paleoclimate\PLSR Model Test\TP Spline";
data Datasets.geo_prediction_results_MOL;
	set geo_pred;
run;


*-------------- Print results (HTML format) -------------------*;
ods html file="C:\Users\RDaneel\Documents\Research\Baylor\BU-SI\Paleoclimate\PLSR Model Test\TP Spline\abc.html";
ods listing;
*/
title2 'Predictions';
